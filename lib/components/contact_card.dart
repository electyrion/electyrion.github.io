  ...
  Widget back = LayoutBuilder(
    ...
    builder: (p0, constraints) {
      return Column(
        ...
        children: [
          const Imager(
            altText: "QR code to get Vicky's contact vCard",
          ...
          SizedBox(
            ...
            child: const FittedBox(
              child: Texter("  App Developer | Photographer",
                style: TextStyle(
                    fontSize: 15,
                    fontWeight: FontWeight.w200
                ),
